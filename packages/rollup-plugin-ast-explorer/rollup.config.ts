  ...
  const assetsConfig: RollupOptions = {
    ...
    plugins: [
      ...
      postcss({
        ...
        extensions: ['.css'],
        // cssnano (minimize) can choke on some calc() expressions generated by Tailwind v4,
        // causing a "Lexical error: infinity * 1px" during minification. Disable the `calc`
        // reduction to avoid that unsafe optimization.
        minimize: isProduction
          ? {
              preset: [
                'default',
                {
                  // turn off postcss-calc
                  calc: false,
                },
              ],
            }
